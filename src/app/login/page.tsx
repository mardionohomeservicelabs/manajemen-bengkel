          ...
          <div className="px-8 py-6">
            ...
            <div className="mt-6 pt-5 border-t border-slate-700/50">
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2.5 text-center flex items-center justify-center gap-1.5">
                ...
                Pilih Akses Cepat (Demo / Uji Coba)
              </p>
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() => {
                    setEmail('ardiyanto@mardiono');
                    setPassword('owner123');
                    setError('');
                  }}
                  className="px-2.5 py-2 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-300 text-left transition text-xs flex flex-col group"
                >
                  <span className="font-bold flex items-center gap-1 text-[11px]">
                    👑 Owner MHS 1
                  </span>
                  <span className="text-[10px] text-slate-400 group-hover:text-amber-200 truncate">
                    Ardiyanto (Semua Hak)
                  </span>
                </button>
                ...
                <button
                  type="button"
                  onClick={() => {
                    setEmail('navira@mardiono');
                    setPassword('owner456');
                    setError('');
                  }}
                  className="px-2.5 py-2 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-300 text-left transition text-xs flex flex-col group"
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    setEmail('arida@mhs1.mardiono');
                    setPassword('mhs1admin');
                    setError('');
                  }}
                  className="px-2.5 py-2 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700 text-slate-300 text-left transition text-xs flex flex-col"
                >
